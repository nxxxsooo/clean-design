...
source_dmg="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/dmg/Clean Design-$TOOLS_PACK_NAMESPACE.dmg"
source_zip="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/zip/Clean Design-$TOOLS_PACK_NAMESPACE.zip"
...
release_notes="${RELEASE_NOTES:-Clean Design $RELEASE_VERSION$asset_suffix}"
