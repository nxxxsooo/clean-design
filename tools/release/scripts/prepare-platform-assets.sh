...
case "$RELEASE_TARGET" in
  mac_arm64 | mac_x64)
    ...
    source_dmg="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/dmg/Clean Design-$RELEASE_NAMESPACE.dmg"
    source_zip="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/zip/Clean Design-$RELEASE_NAMESPACE.zip"
    source_payload="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/payload/Clean Design-$RELEASE_NAMESPACE-payload.zip"
    ...
    release_notes="${RELEASE_NOTES:-Clean Design $RELEASE_VERSION$RELEASE_ASSET_SUFFIX}"
...
EOF
    ;;
  linux_x64)
    source_appimage="$TOOLS_PACK_DIR/out/linux/namespaces/$RELEASE_NAMESPACE/builder/Clean Design-$RELEASE_NAMESPACE.AppImage"
