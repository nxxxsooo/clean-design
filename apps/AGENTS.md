...
- `apps/packaged`: Thin packaged Electron runtime entry. It starts packaged daemon/web sidecars, registers the `cleandesign://` entry protocol, and delegates desktop host behavior to `apps/desktop`.
