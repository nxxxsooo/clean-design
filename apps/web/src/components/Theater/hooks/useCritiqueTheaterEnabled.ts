...
const TOGGLE_EVENT = 'clean-design:critique-theater-toggle';
 ...
 *
 * Source of truth is the isolated `clean-design:config` localStorage
 ...
 *   2. A same-tab `clean-design:critique-theater-toggle` CustomEvent so
