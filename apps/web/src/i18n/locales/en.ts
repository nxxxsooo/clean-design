...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Clean Design Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to Clean Design Cloud & retry',
  'chat.amrError.authMessage': 'Your Clean Design Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Clean Design Cloud balance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Clean Design Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Clean Design Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The Clean Design Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Clean Design Cloud agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update Clean Design to the latest version, which ships a compatible runtime.",
  ...
  'settings.welcomeTitle': 'Welcome to Clean Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Clean Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Clean Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to Clean Design',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to Clean Design',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Clean Design Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Clean Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Clean Design.',
  ...
  'settings.amrAccountStatus': 'Clean Design Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose Clean Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Clean Design team',
  'settings.privacyConsentKicker': 'Help us improve Clean Design',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how Clean Design performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Clean Design starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Clean Design could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Clean Design projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Clean Design is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Clean Design, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'Clean Design must be running for MCP tool calls to succeed. If you started your coding agent before opening Clean Design, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the Clean Design Discord',
  'entry.discordAriaWithOnline': 'Join the Clean Design Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow Clean Design on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Clean Design on Xiaohongshu',
  ...
  'homeHero.searchPrompt': 'Search files, plugins, and skills.',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Clean Design plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Clean Design Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local Clean Design project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Clean Design Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Clean Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Clean Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Clean Design',
  'pluginCard.contributeTitle': 'Contribute plugin to Clean Design with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Clean Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Clean Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Clean Design everywhere',
  'useEverywhere.modalTitle': 'Use Clean Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop Clean Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Clean Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Clean Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Clean Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Clean Design at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Clean Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Clean Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Clean Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Clean Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Clean Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Clean Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Clean Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Clean Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Clean Design extras)',
  ...
  'entry.githubStarAria': 'Star Clean Design on GitHub',
  ...
  'newproj.locationDefault': 'Clean Design projects',
  ...
  'avatar.amrConsole': 'Clean Design Cloud',
  ...
  'socialShare.openDesignSection': 'Share Clean Design',
  'socialShare.openDesignTitle': 'Clean Design on GitHub',
  'socialShare.openDesignText': 'Clean Design is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Clean Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Clean Design: {title}\n{url}\nClean Design repo: {repo}',
  ...
  'brandEnrichment.body': "Clean Design will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Clean Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Clean Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'chat.mentionSearchPrompt': 'Search Design Files, tabs, plugins, and skills.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Clean Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Clean Design? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to Clean Design on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Clean Design on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Clean Design on Xiaohongshu for tips and inspiration.',
  ...
  'assistant.shareToOpenDesign': 'Share to Clean Design',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Clean Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Clean Design — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Clean Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'updater.availableBody': 'Clean Design {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'Clean Design is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'Clean Design could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. Clean Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Clean Design',
  'updater.quitFailedBody': 'The installer is open, but Clean Design could not quit. Quit Clean Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Clean Design will close and open the installer.',
  'updater.readyVersion': 'Clean Design {version} is ready. Clean Design will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach Clean Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Clean Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Clean Design your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Clean Design turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
