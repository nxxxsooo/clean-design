...
export const en: Dict = {
  ...
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its local authentication status, then retry.',
  ...
  'homeHero.subtitlePrefix': 'A local-first visual creation studio.',
