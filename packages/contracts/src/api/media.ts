...
/**
 * Run-scoped policy controlling Clean Design-owned media generation only.
 *
 * `allowedSurfaces` and `allowedModels` apply to `/api/tools/media/generate`
 * and in-run `od media generate`.
 */
