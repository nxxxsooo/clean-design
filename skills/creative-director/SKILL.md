...
## Clean Design orchestration mode

When this skill is invoked inside Clean Design, treat it as the design-flow
...
3. Search across every available Clean Design resource, not only this skill:
