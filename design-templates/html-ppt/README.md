...
> One command installs **36 themes × 20 canvas FX × 31 layouts × 15 full decks + presenter mode**. Every bundled preview is a live iframe of a real template file rendering inside the deck — no screenshots, no mock-ups.
