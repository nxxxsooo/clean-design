...
A small community plugin for exercising the Clean Design import UI. It is meant
...
Clean Design should install the plugin as a user/community plugin, preserve the
