...
description: A portable community plugin for validating Clean Design plugin import flows.
---

# Community Import Smoke Test

Use this plugin when validating that Clean Design can import community plugins
