...
description: >
  ...
  collage) — the same aesthetic Clean Design uses for its own marketing
...
This is the canonical Clean Design marketing-page recipe — the example
...
worked example (Clean Design itself).
...
├── inputs.example.json      # Clean Design as the worked example
...
└── assets/
    ├── *.png                # 16 collage plates (Clean Design instance)
